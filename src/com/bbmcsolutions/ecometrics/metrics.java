...
//ViewPagerIndicator
public class metrics extends RelativeLayout implements OnPageChangeListener {
	...
	public metrics(Context context, AttributeSet attrs) {
		super(context, attrs);
		addContent();
	}
	
	public metrics(Context context, AttributeSet attrs, int defStyle){
	...
	class OnPreviousClickedListener implements android.view.View.OnClickListener{
		public void onClick(View v) {
			if(mOnClickHandler != null){
				mOnClickHandler.onPreviousClicked(metrics.this);
			}
		}
	}
	class OnCurrentClickedListener implements android.view.View.OnClickListener{
		public void onClick(View v) {
			if(mOnClickHandler != null){
				mOnClickHandler.onCurrentClicked(metrics.this);
			}
		}
	}
	class OnNextClickedListener implements android.view.View.OnClickListener{
		public void onClick(View v) {
			if(mOnClickHandler != null){
				mOnClickHandler.onNextClicked(metrics.this);
			}
		}
	}
}
